...
public class PullToRefreshPageScrollView extends PullToRefreshBase<ScrollView> {

	public PullToRefreshPageScrollView(Context context) {
		super(context);
	}

	public PullToRefreshPageScrollView(Context context, AttributeSet attrs) {
		super(context, attrs);
	}

	public PullToRefreshPageScrollView(Context context, Mode mode) {
		super(context, mode);
	}

	public PullToRefreshPageScrollView(Context context, Mode mode, AnimationStyle style) {
	...
	protected int getMaximumPullScroll() {
		switch (getPullToRefreshScrollDirection()) {
			case HORIZONTAL:
				return Math.round(dp2px(50) * 1.5f);
			case VERTICAL:
			default:
				return Math.round(dp2px(50) * 1.5f);
		}
	...
	final class InternalScrollViewSDK9 extends ScrollView {
		...
		protected boolean overScrollBy(int deltaX, int deltaY, int scrollX, int scrollY, int scrollRangeX,
			...
			OverscrollHelper.overScrollBy(PullToRefreshPageScrollView.this, deltaX, scrollX, deltaY, scrollY,
